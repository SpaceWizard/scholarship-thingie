...
--
-- Host: localhost
-- Generation Time: Apr 27, 2013 at 03:34 AM
...
('', 'kbecket', '', 65),
('cadence', 'applejack', 'GPA', 20),
('cadence ', 'baileyd', 'Essay_Career', 4),
('cadence ', 'baileyd', 'Essay_Interest', 2),
('cadence ', 'baileyd', 'GPA', 12),
('cadence ', 'baileyd', 'GRE', 12),
('cadence ', 'baileyd', 'Recc1', 7),
('cadence ', 'baileyd', 'Recc2', 8),
('cadence ', 'baileyd', 'Resume', 30),
('shiningarmor', 'applejack', 'GRE', 12),
('shiningarmor', 'pinkiepie', 'GPA', 25),
('shiningarmor', 'pinkiepie', 'GRE', 30);
...
('cadence', 'kbecket', '0.00'),
('cadence', 'pinkiepie', '0.00'),
('cadence', 'student', '0.00'),
('shiningarmor', 'applejack', '0.00'),
('shiningarmor', 'baileyd', '0.00'),
('shiningarmor', 'student', '0.00');
...
('Everett L Holden Marian G Holden Memorial Scholarship Fund', 1, 500, '2013-02-01'),
('J W Martin and A M Martin Phillips Scholarship Fund', 2, 400, '2013-04-23'),
('John F and Marjorie J Alexander Scholarship', 1, 300, '2013-02-01');
...
('J W Martin and A M Martin Phillips Scholarship Fund', 400, 'HS Alachua County', 11);
...
('Everett L Holden Marian G Holden Memorial Scholarship Fund', 500, 'Financial Need', 2),
('Everett L Holden Marian G Holden Memorial Scholarship Fund', 500, 'Full-time', 1),
('Everett L Holden Marian G Holden Memorial Scholarship Fund', 500, 'Grad', 0),
('Everett L Holden Marian G Holden Memorial Scholarship Fund', 500, 'Undergrad', 0),
('J W Martin and A M Martin Phillips Scholarship Fund', 300, 'Full-time', 1),
('J W Martin and A M Martin Phillips Scholarship Fund', 300, 'Grad', 2),
('John F and Marjorie J Alexander Scholarship', 300, 'PROTEACH', 3),
('John F and Marjorie J Alexander Scholarship', 300, 'Undergrad', 4);
...
('applejack', 'William Bodine', 'BAE', 'Marriage and Family Counseling', '2013-04-12', 1, '4.00', 0, 'Canterlot', 'nowhere', 0, 'sweet apple acres', 'sweet apple acres', '', '', '', 'None', 0, 1, '85.00000000'),
('baileyd', 'Bailey Vickers', 'MED', 'Elementry Education ProTeach', '2013-05-01', 1, '3.86', 30, '', '', 0, '8137 Burning Leaf Front Burning Leaf Front, Coffee Hill, Oklahoma, 74403', '3678 Iron Hickory Private, Port Safety, Washington, 98808', 'bvickers@gmail.com', '(918) 401-8330', '(360) 133-9077', 'Social Studies Education', 0, 1, '75.00000000'),
('kbecket', '', 'BAE', 'Marriage and Family Counseling', '0000-00-00', 0, '0.00', 0, '', '', 0, '', '', '', '', '', 'None', 0, 1, '65.00000000'),
('pinkiepie', 'Meredith Bury', 'BAE', 'Marriage and Family Counseling', '0000-00-00', 0, '0.00', 0, '', '', 0, '', '', '', '', '', 'None', 0, 1, '55.00000000');
...
('baileyd', 'Full-time'),
('baileyd', 'Grad'),
('baileyd', 'Save and Continue'),
('kbecket', 'Financial Need'),
('kbecket', 'Full-time'),
('kbecket', 'Grad'),
('kbecket', 'HS Alachua County'),
('kbecket', 'Save and Continue'),
('pinkiepie', 'Financial Need'),
('pinkiepie', 'Full-time'),
...
CREATE TABLE IF NOT EXISTS `student_scholarship` (
  `Student` varchar(64) COLLATE utf8_unicode_ci NOT NULL,
  `scholarship` varchar(64) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `student_scholarship` (`Student`, `ScholarshipName`, `AwardAmount`) VALUES
('baileyd', 'Everett L Holden Marian G Holden Memorial Scholarship Fund', 500),
('baileyd', 'J W Martin and A M Martin Phillips Scholarship Fund', 400),
('applejack', 'Everett L Holden Marian G Holden Memorial Scholarship Fund', 500),
('applejack', 'John F and Marjorie J Alexander Scholarship', 300),
('kbecket', 'Everett L Holden Marian G Holden Memorial Scholarship Fund', 500),
('kbecket', 'J W Martin and A M Martin Phillips Scholarship Fund', 400),
('pinkiepie', 'Everett L Holden Marian G Holden Memorial Scholarship Fund', 500),
('pinkiepie', 'J W Martin and A M Martin Phillips Scholarship Fund', 400),
('pinkiepie', 'John F and Marjorie J Alexander Scholarship', 300);
...
('Everett L Holden Marian G Holden Memorial Scholarship Fund', 500, 'kbecket'),
('Everett L Holden Marian G Holden Memorial Scholarship Fund', 500, 'pinkiepie'),
('John F and Marjorie J Alexander Scholarship', 300, 'applejack'),
('J W Martin and A M Martin Phillips Scholarship Fund', 400, 'baileyd'),
('J W Martin and A M Martin Phillips Scholarship Fund', 400, 'kbecket'),
('J W Martin and A M Martin Phillips Scholarship Fund', 400, 'pinkiepie'),
('Everett L Holden Marian G Holden Memorial Scholarship Fund', 500, 'kbecket'),
('Everett L Holden Marian G Holden Memorial Scholarship Fund', 500, 'pinkiepie'),
('John F and Marjorie J Alexander Scholarship', 300, 'applejack'),
('J W Martin and A M Martin Phillips Scholarship Fund', 400, 'baileyd'),
...
--
-- Table structure for table `temp_bouns`
--

CREATE TABLE IF NOT EXISTS `temp_bouns` (
  `ScholarshipName` varchar(128) DEFAULT NULL,
  `AwardAmount` int(11) DEFAULT NULL,
  `Student` varchar(128) DEFAULT NULL,
...
--
-- Dumping data for table `temp_bouns`
--

INSERT INTO `temp_bouns` (`ScholarshipName`, `AwardAmount`, `Student`, `Weight`) VALUES
('J W Martin and A M Martin Phillips Scholarship Fund', 400, 'kbecket', 11);

-- --------------------------------------------------------

--
-- Table structure for table `temp_eligible`
--

CREATE TABLE IF NOT EXISTS `temp_eligible` (
  `ScholarshipName` varchar(128) DEFAULT NULL,
  `AwardAmount` int(11) DEFAULT NULL,
  `Student` varchar(128) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `temp_eligible`
--

INSERT INTO `temp_eligible` (`ScholarshipName`, `AwardAmount`, `Student`) VALUES
('Everett L Holden Marian G Holden Memorial Scholarship Fund', 500, 'kbecket'),
('Everett L Holden Marian G Holden Memorial Scholarship Fund', 500, 'pinkiepie'),
('J W Martin and A M Martin Phillips Scholarship Fund', 300, 'baileyd'),
('J W Martin and A M Martin Phillips Scholarship Fund', 300, 'kbecket'),
('John F and Marjorie J Alexander Scholarship', 300, 'applejack'),
('J W Martin and A M Martin Phillips Scholarship Fund', 400, 'applejack'),
('J W Martin and A M Martin Phillips Scholarship Fund', 400, 'baileyd'),
('J W Martin and A M Martin Phillips Scholarship Fund', 400, 'kbecket'),
('J W Martin and A M Martin Phillips Scholarship Fund', 400, 'pinkiepie');
...
('apple', 'jxaGOq1Hoi17NgNCAApvX40K77SPSOz9UwWXLvyk75g=', '16', 'referer'),
...
('castle', '5asIMOyDdGxY52pp0h9RLT17535aueU5+QcpRZJuQrk=', '16', 'referer'),
('committee', 'Ce90rfT5dMJy7EmTaU6baBLNLQyeXLADeq3O/rg6r3Q=', '16', 'committee'),
('derpy', 'egMF1EKLbaTUFCKIl6RNRxiADz7wQseyUpKvkVNjAGw=', '16', 'admin'),
('kbecket', 'pOvc2DUQuB8IipsRBOUr9Sk0CdQ9TnphYvvbuZLX+ro=', '16', 'student'),
('pinkiepie', 'DHGnPoD8ZSOB3JVPOdYeSqlbrKCzMBgi22V7ydgDTrU=', '16', 'student'),
('referer', 'PHtqKDYMSNPhJBvaJkuLhLHjdMBbrWx0Gs/bgEIHBGk=', '16', 'referer'),
('referer2', 'Y8D1TkC5tJcbNdTYG/w/mIKNmgEaYtXwP7O5QDOO+Ms=', '16', 'referer'),
('referer3', 'xjbgKbKsm3Jugbl8AdsDMCW3ifwtNQZSK2y2Fxp49U4=', '16', 'referer'),
('shiningarmor', 'kBHuaDkhwDAuRMMBmUPgYGKSjdPl8b3CE5a7DPdfQF4=', '16', 'committee'),
('student', 'fYQ4Zc2OXgXjBG5DZy7PKQiA/TyZcOBmlHvV/r9d6w0=', '16', 'student'),
('student1', 'QQo3yYU5iQsZRr+NBFihOY9DipakH9xZcoHDS7RfTbg=', '16', 'student');
...
INSERT INTO `winners` (`student`, `scholarship`, `amount`) VALUES
('J W Martin and A M Martin Phillips Scholarship Fund', '400', 0);
